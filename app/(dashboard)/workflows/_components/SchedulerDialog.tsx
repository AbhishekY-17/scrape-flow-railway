...
import { UpdateWorkflowCron } from '@/action/workflows/updateWorkflowCron';
import { toast } from 'sonner';
import cronstrue from 'cronstrue';
import parser from 'cron-parser';
import { RemoveWorkflowSchedule } from '@/action/workflows/removeWorkflowSchedule';
    ...
    <Dialog>
        ...
        <DialogContent className='px-0'>
            ...
            <div className='p-6 space-y-4'>
                ...
                >
                    {validCron ? readableCron : "Not a vaild cron expresson"}
                </div>

                {workflowHasValidCron && <DialogClose asChild>
                    <div>
                        <Button className='w-full text-destructive border-destructiv' 
                            variant={"outline"} 
