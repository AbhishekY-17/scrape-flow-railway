import { GetPeriods } from '@/action/analytics/getPeriods';
import React, { Suspense } from 'react'
import PeriodSelector from './_components/PeriodSelector';
import { Period } from '@/types/analytics';
import { waitFor } from '@/lib/helper/waitFor';
import { Skeleton } from '@/components/ui/skeleton';
import { GetStatsCardsValue } from '@/action/analytics/getStatsCardsValue';
import { CirclePlay, CirclePlayIcon, CoinsIcon, WaypointsIcon } from 'lucide-react';
import StatsCard from './_components/StatsCard';
import { GetWorkflowExecutionStats } from '@/action/analytics/getWorkflowExecutionStats';
import ExecutionStatusChart from './_components/ExecutionStatusChart';
import { GetCreditUsageInPeriod } from '@/action/analytics/getCreditUsageInPeriod';
