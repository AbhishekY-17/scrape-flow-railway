...
import { GetCredentialsForUser } from '@/action/credentials/getCredentialsForUser';
import { Card } from '@/components/ui/card';
import CreateCredentialDialog from './CreateCredentialsDialog';
            ...
            <Card className='w-full p-4'>
                <div className='flex flex-col gap-4 items-center justify-center'>
                    ...
                    <div className='flex flex-col gap-1 text-center'>
                        ...
                        <p className='text-sm text-muted-foreground'>Click the button below to create your first credntial</p>
                    </div>
